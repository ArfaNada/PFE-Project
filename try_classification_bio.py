#!/usr/bin/env python
"""
Bio Sentiment Classification - Algorithm Comparison

This script compares multiple classification algorithms on author bio sentiment
...
def prepare_data(data_path):
    ...
    data = data.drop(columns=["Tweet", "Tweet_Sentiment"], axis=1, errors='ignore')
